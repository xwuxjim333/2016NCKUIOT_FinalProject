...
class DecisionAction():
    def Judge(self, _obj_json_msg):
        ...
        if (spreate_obj_json_msg["Control"] == "M2M_REQTOPICLIST"):
            ...
            time.sleep(1)
            m2mfsmrules.replyM2MTopicToNode("AHotel@FS-43211234-5432-4321-654321654321", spreate_obj_json_msg["Node"])


        elif (spreate_obj_json_msg["Control"] == "M2M_GETRULE"):
            m2mfsmrules = FunctionServerMappingRules()
            m2mfsmrules.replyM2MRulesAll("AHotel@FS-43211234-5432-4321-654321654321")
