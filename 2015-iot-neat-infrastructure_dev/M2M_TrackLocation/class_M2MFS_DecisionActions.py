...
class DecisionAction():
    def Judge(self, _obj_json_msg):
        ...
        if (spreate_obj_json_msg["Control"] == "M2M_REQTOPICLIST"):
            ...
            time.sleep(1)
            m2mfsmrules.replyM2MTopicToNode("TrackLocation@FS-12344321-2345-1234-123456123456", spreate_obj_json_msg["Node"])


        elif (spreate_obj_json_msg["Control"] == "M2M_GETRULE"):
            m2mfsmrules = FunctionServerMappingRules()
            m2mfsmrules.replyM2MRulesAll("TrackLocation@FS-12344321-2345-1234-123456123456")
