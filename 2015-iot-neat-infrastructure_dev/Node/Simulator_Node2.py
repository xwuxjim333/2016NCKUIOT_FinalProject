...
import NIT_Node_Module2
from terminalColor import bcolors

NodeUUID = "B0107@NODE-8c987879-958f-44e4-b1ac-010701070107"
...
nit = NIT_Node_Module2.NIT_Node(NodeUUID, Functions, NodeFunctions)
...
def loop():
    ...
    initMSGObj = {'TopicName': "B0107@NODE-8c987879-958f-44e4-b1ac-010701070107/SW1", 'Control': 'M2M_SET', 'Source': "B0107@NODE-8c987879-958f-44e4-b1ac-010701070107", 'M2M_Value': flip}
    initMSGSTR = json.dumps(initMSGObj)

    if (decide == "t"):
        nit.DirectMSG("B0107@NODE-8c987879-958f-44e4-b1ac-010701070107/SW1", initMSGSTR)
        print("SW01 SENT.")
        flip = (~flip)
